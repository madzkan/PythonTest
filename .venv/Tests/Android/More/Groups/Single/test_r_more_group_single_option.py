...
def test_more_groups_single_auth(driver):
    ...
    # 5. Click 'ANDROID.WIDGET.IMAGEVIEW1'
    # android_widget_imageview1 = driver.find_element(By.XPATH, "//android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup[2]/android.view.ViewGroup[1]/android.view.ViewGroup[2]//android.widget.ImageView")
    # android_widget_imageview1.click()
    click_ellips = driver.find_element(By.XPATH, "//android.widget.TextView[@text = '']")
    click_ellips.click()

    time.sleep(5)

    # 6. Is 'ANDROID.VIEW.VIEWGROUP1' present?
    android_view_viewgroup1 = driver.find_element(By.XPATH,
                                                  "//android.view.ViewGroup[2]/android.widget.ScrollView[1]/android.view.ViewGroup[1]/android.view.ViewGroup/android.view.ViewGroup")