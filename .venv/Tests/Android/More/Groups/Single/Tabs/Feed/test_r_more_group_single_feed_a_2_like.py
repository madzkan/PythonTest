...
def test_more_groups_single_feed_a_2(driver):
    ...
    click_single_post_option_ell = driver.find_element(By.XPATH, "//android.view.ViewGroup[5]/android.widget.TextView[@text = '']")
    click_single_post_option_ell.click()

    # 8. Does 'Unlike' contain 'Unlike'?
    unlike = driver.find_element(By.XPATH,
                                 "//android.widget.TextView[@text = 'Unlike']")
    step_output = unlike.text
    assert step_output and ("Unlike" in step_output)