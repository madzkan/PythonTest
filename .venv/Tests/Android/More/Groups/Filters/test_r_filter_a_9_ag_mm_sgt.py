...
def test_more_groups_filter_9(driver):
    ...
    # android_widget_imageview8 = driver.find_element(By.XPATH, "//android.widget.ScrollView/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[2]/android.view.ViewGroup[1]/android.view.ViewGroup/android.widget.ImageView")
    ...
    most_members = driver.find_element(By.XPATH, "//android.widget.TextView[@text = 'Most Members']")
    most_members.click()
