...
def test_activity_pp_postconn(driver):
    ...
    # 3. Click 'My Connections'
    my_connections = driver.find_element(By.XPATH,
                                         "//android.widget.TextView[@text = 'My Connections']")
    ...
    # 5. Type 'test my conn' in 'Write here or use @ to mention someone.'
    write_here_or_use_to_mention_someone_ = driver.find_element(By.XPATH,
                                                                "//android.widget.EditText[@text = 'Write here or use @ to mention someone.']")
    write_here_or_use_to_mention_someone_.send_keys("test my conn")
