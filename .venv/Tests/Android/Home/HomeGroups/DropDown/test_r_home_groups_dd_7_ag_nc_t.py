...
def test_homeforums_id_filter_3(driver):
    ...
    # 4. Click 'Newly Created4'
    newly_created4 = driver.find_element(By.XPATH,
                                         "//android.widget.TextView[@text = 'Newly Created']")
    newly_created4.click()
    ...
    team = driver.find_element(By.XPATH,
                               "//android.widget.TextView[@text = 'Team']")
    team.click()
    ...
    # 9. Does 'Newly Created1' contain 'Newly Created'?
    ...
    # 10. Is 'ANDROID.VIEW.VIEWGROUP13' is clickable?
