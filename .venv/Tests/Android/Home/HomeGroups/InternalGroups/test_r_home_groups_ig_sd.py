...
def test_home_groups_single_discussion(driver):
    ...
    # 4. Click 'Every man’s work, whether it be liter...'
    every_man_s_work_whether_it_be_liter_ = driver.find_element(By.XPATH,
                                                                "//android.widget.TextView[@text = 'Every man’s work, whether it be literature, or music or …']")
    every_man_s_work_whether_it_be_liter_.click()

    time.sleep(5)

    # 5. Does 'Architecture3' contain 'Architecture'?
    architecture3 = driver.find_element(By.XPATH,
                                        "//android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup/android.widget.TextView[@text = 'Architecture']")
    step_output = architecture3.text
