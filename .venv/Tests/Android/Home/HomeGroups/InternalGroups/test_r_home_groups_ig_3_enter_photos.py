...
def test_home_groups_enter_photos(driver):
    ...
    # 4. Click 'Photos2'
    photos2 = driver.find_element(By.XPATH,
                                  "//android.widget.TextView[@text = 'Photos']")
    photos2.click()

    time.sleep(5)

    # 5. Does 'Photos1' contain 'Photos'?
    ...
    # 6. Is 'ANDROID.WIDGET.IMAGEVIEW39' is clickable?
    android_widget_imageview39 = driver.find_element(By.XPATH,
                                                     "//android.widget.ScrollView//android.widget.ImageView")
    assert android_widget_imageview39.is_enabled()