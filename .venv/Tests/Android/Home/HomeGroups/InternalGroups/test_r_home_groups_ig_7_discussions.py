...
def test_home_groups_discussion(driver):
    ...
    #         topMarginPercent=0,
    #         maxSwipes=0,
    #         timeoutMilliseconds=0), *discussions_gh)

    driver.swipe(start_x=1023, start_y=1183, end_x=945, end_y=466, duration=300)

    # 5. Click 'Discussions - gh'
    discussions_gh = driver.find_element(By.XPATH,
                                         "//android.widget.TextView[@text = 'Discussions']")
    discussions_gh.click()
