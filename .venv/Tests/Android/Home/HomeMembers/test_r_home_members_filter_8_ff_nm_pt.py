...
def test_home_members_filter_1(driver):
    ...
    # see_all4.click()
    see_all3 = driver.find_element(By.XPATH,
                                    "//android.view.ViewGroup[3]//android.widget.TextView[@text = 'See all']")
    see_all3.click()
    ...
    # 5. Click 'Newest Members - im'
    newest_members_im = driver.find_element(By.XPATH,
                                            "//android.widget.TextView[@text = 'Newest Members']")
    newest_members_im.click()
