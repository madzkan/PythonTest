...
def test_home_members_filter_1(driver):
    ...
    all_members1 = driver.find_element(By.XPATH, "//android.widget.TextView[@text = 'All Members']")
    all_members1.click()

    # 4. Click 'Connections - im'
    connections_im = driver.find_element(By.XPATH, "//android.widget.TextView[@text = 'Connections']")
