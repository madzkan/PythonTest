...
def test_homeforums_id_filter_7(driver):
    ...
    # 4. Swipe 'Up' to 'Discussions-Internal'
    ...
    #         topMarginPercent=0,
    #         maxSwipes=0,
    #         timeoutMilliseconds=0), *discussions_internal)

    driver.swipe(start_x=1023, start_y=1183, end_x=945, end_y=466, duration=300)

    # 5. Click 'Discussions-Internal'
    discussions_internal = driver.find_element(By.XPATH,
                                               "//android.widget.TextView[@text = 'Discussions']")
    discussions_internal.click()

    time.sleep(5)

    # 6. Does 'Discussions1' contain 'Discussions'?
