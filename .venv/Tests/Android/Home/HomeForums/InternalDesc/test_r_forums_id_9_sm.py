...
def test_homeforums_id_filter_9(driver):
    ...
    # 4. Swipe 'Up' to 'Send Messages - hf ie'
    # send_messages_hf_ie = (
    ...
    #         topMarginPercent=0,
    #         maxSwipes=0,
    #         timeoutMilliseconds=0), *send_messages_hf_ie)

    driver.swipe(start_x=1023, start_y=1183, end_x=945, end_y=466, duration=300)

    # 5. Click 'Send Messages - hf ie'
    send_messages_hf_ie = driver.find_element(By.XPATH,
                                              "//android.widget.TextView[@text = 'Send Messages']")
    send_messages_hf_ie.click()
