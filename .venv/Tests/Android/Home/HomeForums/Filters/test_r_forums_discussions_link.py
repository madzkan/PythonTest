...
def test_homeforums_filter_4(driver):
    ...
    # 2. Click '4 Discussions'
    _4_discussions = driver.find_element(By.XPATH,
                                         "//android.view.ViewGroup[2]/android.view.ViewGroup[1]/android.view.ViewGroup/android.widget.TextView[@text = '4 Discussions']")
    _4_discussions.click()
