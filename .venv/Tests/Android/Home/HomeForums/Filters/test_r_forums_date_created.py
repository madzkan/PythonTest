...
def test_homeforums_filter_2(driver):
    ...
    date_created = driver.find_element(By.XPATH,
                                       "//android.widget.TextView[@text = 'Date Created']")
    date_created.click()

    time.sleep(5)

    # 3. Does 'Date Created' contain 'Date Created'?
    date_created = driver.find_element(By.XPATH,
                                       "//android.widget.TextView[@text = 'Date Created']")
    step_output = date_created.text
    assert step_output and ("Date Created" in step_output)