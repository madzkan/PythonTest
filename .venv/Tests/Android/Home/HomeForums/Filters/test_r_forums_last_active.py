...
def test_homeforums_filter_8(driver):
    ...
    # 2. Click 'Last Active'
    last_active = driver.find_element(By.XPATH,
                                      "//android.widget.TextView[@text = 'Last Active']")
    last_active.click()

    time.sleep(5)

    # 3. Does 'Last Active' contain 'Last Active'?
    last_active = driver.find_element(By.XPATH,
                                      "//android.widget.TextView[@text = 'Last Active']")
    step_output = last_active.text
    assert step_output and ("Last Active" in step_output)