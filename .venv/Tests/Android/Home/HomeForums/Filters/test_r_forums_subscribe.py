...
def test_homeforums_filter_10(driver):
    ...
    _ = driver.find_element(By.XPATH,
                            "//android.view.ViewGroup[2]/android.view.ViewGroup[1]/android.view.ViewGroup[2]//android.widget.TextView[@text = '']")
    _.click()

    time.sleep(5)

    # 3. Click 'Subscribe1'
    subscribe1 = driver.find_element(By.XPATH,
