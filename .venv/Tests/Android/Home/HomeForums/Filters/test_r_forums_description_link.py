...
def test_homeforums_filter_3(driver):
    ...
    # 2. Click 'Every man's work, whether it be liter...'
    every_man_s_work_whether_it_be_liter_ = driver.find_element(By.XPATH, "//android.widget.TextView[@text = concat('Every man', \"'\", 's work, whether it be literature, or music or pictures or architecture or anything else, is always a portrait of himself.')]")
