...
def test_homeforums_id_filter_10(driver):
    ...
    # 5. Click 'Spam1'
    spam1 = driver.find_element(By.XPATH,
                                "//android.widget.TextView[@text = 'Spam']")
    spam1.click()

    time.sleep(5)

    # 6. Click 'ANDROID.WIDGET.IMAGEVIEW36'
    # android_widget_imageview36 = driver.find_element(By.XPATH,
    #                                                  "//android.view.ViewGroup[2]/android.view.ViewGroup[1]/android.view.ViewGroup[3]/android.widget.ImageView")
    # android_widget_imageview36.click()
    ...
    # 7. Does 'Unspam1' contain 'Unspam'?
    unspam1 = driver.find_element(By.XPATH,
                                  "//android.widget.TextView[@text = 'Unspam']")
    step_output = unspam1.text
    assert step_output and ("Unspam" in step_output)
